var AreaHighchartView = (function(_super) {
    ...
    __extends(AreaHighchartView, _super);

    function AreaHighchartView(view, finalData, monthData) {
        this.view = view;
        this.finalData = finalData;
        this.monthData = monthData;
        this.destroy = __bind(this.destroy, this);
        this.resize = __bind(this.resize, this);
        AreaHighchartView.__super__.constructor.call(this, this.view);
    ...
    AreaHighchartView.prototype.setChart = function(chartOption) {
    ...
    AreaHighchartView.prototype.resize = function(evt) {
      if(this.chart){
...
this.chart.options.yAxis[0].title.style.fontSize = "0.8em", 
    ...
    AreaHighchartView.prototype.destroy = function() {
        this.chart.destroy();
    };

    AreaHighchartView.prototype.chart1 = function() {
    ...
    legend: {
        ...
        title: {
            text: 'Number of Solemnisation Over Past 12 Months',
        ...
        tooltip: {
            //pointFormat: {series.name}+':'+{point.percentage:.1f}%+':'+{point.y:,.0f};
    ...
    AreaHighchartView.prototype.chart1Click = function() {
    ...
    return AreaHighchartView;

})(BaseView);

elx.AreaHighchartView = AreaHighchartView;
